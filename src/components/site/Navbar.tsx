      ...
      <div className="container flex h-20 items-center justify-between">
        ...
        <div className="hidden lg:flex items-center gap-3">
          ...
          {user ? (
            ...
            <>
              <Button variant="ghost" size="sm" asChild className={onLight ? "text-foreground hover:text-foreground hover:bg-foreground/10" : "text-white hover:text-white hover:bg-white/10"}>
